...
Работает. Но ругается что используется устаревшая версия.
...
Устанавливая путь к terraform в перемунной PATH мы можем выбирать какую версию програмы использовать.
